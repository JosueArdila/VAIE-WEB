...
<body id="page-top">
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6">
                          <div class="form-group">
                              <input id="search" autocomplete="off" type="text" class="form-control" placeholder="Nombre del Grupo" data-toggle="tooltip" data-placement="right" title="Nombre del grupo">
                          </div>
                        </div>
                        <div class="col-lg-6 col-md-6">            
                          <div class="row">
                            <div class="form-group col-lg-6 col-md-12">
                              <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="mostrarAct">
                                <label class="custom-control-label" for="mostrarAct">Mostrar Activos</label>
                              </div>
                            </div>
                            <div class="form-group col-lg-6 col-md-12">
                              <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="mostrarInc">
                                <label class="custom-control-label" for="mostrarInc">Mostrar Inactivos</label>
                              </div>
                            </div>
                          </div>  
                        </div>
                          ...
                          <div class="col-lg-3 col-md-3">
                            <div class="container pl-0 pr-0">
                              <div class="row d-flex flex-row-reverse">
                                  <div class="col-lg-auto col-md-auto"><a href="redireccionar-editar-grupo/<?php echo $grupo['id'] ?>" class="btn btn-outline-warning btn-sm">Editar</a>
                                  </div>
                              </div>
                            </div>
                          </div>               
              ...
              <div  class="row justify-content-center">
                <div class="card shadow col-lg-auto col-md-auto">
                  <div class="row mb-2 mt-2 mr-1 ml-1 justify-content-center" >
                    <a href="generar-pdf-grupos" class="btn btn-outline-danger btn-sm ml-2 mr-2">Exportar PDF</a>
                    <a href="generar-excel-grupos" class="btn btn-outline-success btn-sm ml-2 mr-2">Exportar Excel</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script src="js/request-axios/eventos-vice/events-list-grupo.js"></script>
