...
<div class="container">
      ...
      <div class="row mb-2 mt-2 mr-1 ml-1">
        <div class="card col-lg-12">
          <div class="card-body pb-2 pt-2 pr-2 pl-2">
            <div class="row">
              <div class="col-lg-4 col-md-4"><span class="label label-default">Nombre Del Producto</span></div>
              <div class="col-lg-5 col-md-4"><span class="label label-default">Tipo de producto</span></div>
  ...
  <div  class="row justify-content-center">
    <div class="card shadow col-lg-4 col-md-6">
