...
<body id="page-top">
                    ...
                    <div class="row mb-2 mt-2 mr-1 ml-1">
                      <div class="card col-lg-12">
                        <div class="card-body pb-2 pt-2 pr-2 pl-2">
                          <div class="row">
                            <div class="col-lg-11 col-md-3"><span class="label label-default"><?php echo $datos[0]?></span></div>             
                            <div class="col-lg-1 col-md-2"><a href="ver-director-vi/<?php echo $datos[1] ?>" class="btn btn-outline-success btn-sm">Ver</a></div>
                          </div>
                        </div>
                      </div>
                    </div>
           ...
           <div  class="row justify-content-center">
                <div class="card shadow col-lg-auto col-md-auto">
                  <div class="row mb-2 mt-2 mr-1 ml-1 justify-content-center" >
                    <a href="generar-pdf-directores" class="btn btn-outline-danger btn-sm ml-2 mr-2">Exportar PDF</a>
  ...
  <script src="js/request-axios/eventos-vice/events-list-director.js"></script>
