                    ...
                    <div class="row">
                      <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" id="" placeholder="Nombre del Joven Inv.">
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-lg-6 col-md-12">
                            <div class="custom-control custom-switch">
                              ...
                              <label class="custom-control-label" for="ocultarInc">Mostrar Historicos</label>
                            </div>
                          </div>
                        </div>  
                      </div>
                ...
                <div class="row mb-2 mt-2 mr-1 ml-1">
                  <div class="card col-lg-12">
                    <div class="card-body pb-2 pt-2 pr-2 pl-2">
                      <div class="row">
                        <div class="col-lg-3 col-md-3"><span class="label label-default">Nombre del Joven In.</span></div>
                        <div class="col-lg-4 col-md-3"><span class="label label-default">Nombre Del Grupo de In.</span></div>
                        <div class="col-lg-2 col-md-2"><span class="label label-default">24/12/1994</span></div>
