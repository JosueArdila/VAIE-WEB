      ...
      <div class="row mb-2 mt-2 mr-1 ml-1">
        <div class="card col-lg-12">
          <div class="card-body pb-2 pt-2 pr-2 pl-2">
            <div class="row">
              <div class="col-lg-3 col-md-3"><span class="label label-default">Nombre Del Proyecto</span></div>
              <div class="col-lg-3 col-md-3"><span class="label label-default">Nombre Del Director</span></div>
              <div class="col-lg-6 col-md-6">
                <div class="container pl-0 pr-0">
                  <div class="row d-flex flex-row-reverse">
                    <div class="col-lg-auto col-md-auto"><a href="#" class="btn btn-success btn-sm">Ver</a></div>
                    <div class="col-lg-auto col-md-auto"><a href="#" class="btn btn-warning btn-sm">Evaluar</a></div>
                    <div class="col-lg-auto col-md-auto"><a href="#" class="btn btn-warning btn-sm">Edit. Info</a></div>
                    <div class="col-lg-auto col-md-auto"><a href="#" class="btn btn-warning btn-sm">Edit. Colav.</a></div>
                  </div>
                </div>
              </div>
            </div>
