              ...
              <div class="col-lg-10 col-md-12">
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold">Actualizar datos del programa</h6>
                  </div>
                  <div class="card-body">
                      <form method="post" action="editarPrograma">
                      <div class="form-group">
                          <input name="nombre"autocomplete="off" type="text" class="form-control"  placeholder="<?php echo $programa['nombre']?>">
                      </div>
                      <div class="row">
                        <div class="form-group col-lg-10 col-md-10">
                          <select name="facultad" id="fac-editar-pro" class="form-control" data-toggle="tooltip" data-placement="right" title="Facultades">                  
                          </select>    
                        </div>
