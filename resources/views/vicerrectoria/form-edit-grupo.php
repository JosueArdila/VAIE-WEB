...
<body id="page-top">
          ...
          <div class="container">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      <form method="post" action="editarGrupo">
                        <?php
                          if ($registro===1) {?>
                          ...
                          <?php }  elseif ($registro===3) { ?> 
                            <div class="alert alert-danger alert-dismissable">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <strong>¡ Error !</strong> Debes seleccionar un director.
                          </div>
                          <?php } ?>
                      <div class="form-group">
                          <input name="nombre" autocomplete="off" type="text" class="form-control" placeholder="<?php echo($grupo['nombre']) ?>" data-toggle="tooltip" data-placement="right" title="Nombre del grupo">
                      </div>
                      <div class="form-group">
                          <input name="descripcion" autocomplete="off" type="text" class="form-control" placeholder="<?php echo($grupo['descripcion']) ?>" data-toggle="tooltip" data-placement="right" title="Descripcion del grupo">
                      </div>

                      <div class="row">
                        <div class="form-group col-lg-6 col-md-12">
                          <input name="cod" autocomplete="off" type="text" class="form-control" placeholder="<?php echo($grupo['cod_colciencias']) ?>" data-toggle="tooltip" data-placement="right" title="Codigo Colciencias">
                        </div>
                        <div class="form-group col-lg-6 col-md-12">
                      ...
                      <div class="form-group">
                          <select name="docente" id="doc-edit-grupo" class="form-control" data-toggle="tooltip" data-placement="right" title="Docentes">
                          </select>  
                      </div>
                      <div class="container">
                      <div class="row justify-content-center">
  ...
  <script src="js/request-axios/eventos-vice/events-editar-grupo.js"></script>
