          ...
          <div class="container">
                <div class="row justify-content-center d-flex align-items-center">
                    <div class="col-lg-4 col-md-6 col-sm-10">
                      <a href="listar-grupos-inv" class="text-decoration-none">
                        <div class="row mb-4">
                          <div class="col-lg-12">
                      ...
                      <a href="listar-docentes-di" class="text-decoration-none">
                        <div class="row mb-4">
                          <div class="col-lg-12">
                            <div class="card border-left-danger shadow h-100 py-2">
                                      <div class="card-body">
                      ...
                      <a href="listar-proyectos-di" class="text-decoration-none">
                        <div class="row mb-4">
                          <div class="col-lg-12">
                            <div class="card border-left-danger shadow h-100 py-2">
                                      <div class="card-body">
                      ...
                      <a href="listar-productos-di" class="text-decoration-none">
                        <div class="row mb-4">
                          <div class="col-lg-12">
                            <div class="card border-left-danger shadow h-100 py-2">
                                      <div class="card-body">
