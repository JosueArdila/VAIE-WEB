...
$(function(){
	...
	.then((response) => {
		...
		$('#facultad-list-docente').append("<option>Seleccione la Facultad</option>");
				  ...
				  <div class="row mb-2 mt-2 mr-1 ml-1">
			        <div class="card col-lg-12">
			          <div class="card-body pb-2 pt-2 pr-2 pl-2">
			            <div class="row">
			              <div class="col-lg-7 col-md-3"><span class="label label-default">${item[0]}</span></div>
			              <div class="col-lg-4 col-md-3"><span class="label label-default">${select}</span></div>              
			              <div class="col-lg-1 col-md-2"><a href="ver-docente-vi/${item[1]}" class="btn btn-outline-success btn-sm">Ver</a></div>
			            </div>
			          </div>
			        </div>
			      </div>                        
